Q & A with Client:
  1. What platform should this game be able to be run on?
...
> > play it for longer, that is better.
  1. What rating should we design the game for?
...
> > in the game
  1. Should we include multiplayer aspects?
...
> > are no restrictions at this point.
  1. Should the player be able to save the game?
> > It is up to you, but there will be no requirement for that feature
  1. How graphically intense should the game be?
> > You can keep it minimal as long as it doesn't look repetitive
  1. What should controllers should be used in the game?
...
> > controllers if you like, such as joystick, but it won't be required
  1. What resolutions do you want the game to support?
> > 640x480 to 1024x768
  1. Should we include a high score table?
...
> > of user progress. Like a high score table, a point system, achievements, etc.
  1. How many difficulty levels should there be?
> > Just one is required
  1. Should we include sound effects?
> > Yes, you can use sounds created by others, just make sure you give them credit
  1. Should we include a storyline?
> > It is not required.
  1. Can we use copyrighted material?
> > No. 

&lt;Amendment&gt;

 You can use copyrighted material because it falls under education
...
> > sounds and images that you have used.
  1. Should we have AI controlled characters?
...
> > have the required material to run the game.
  1. What is an acceptable amount of glitches?
